...
Age: 18-48, mean= 21
Gender: m=8 f=26, nb=1 prefer not to answer=1 (from Google Sheet, can get this by summarizing by Subj_num and Gender)
...
Hispanic (Latinx?): y=33, n=3 (from Google Sheet, can get this by summarizing by Subj_num and Latinx)
